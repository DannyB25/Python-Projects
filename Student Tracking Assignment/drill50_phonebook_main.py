...
class ParentWindow(Frame): #creating class of ParentWindow and associating w/ Tkinter Frame 
    def __init__(self, master, *args, **kwargs): #initializing values. self references class and master references frame 
        ...
        self.master.minsize(500,350) #(Height, Width). setting the minimum size dimensions  
        self.master.maxsize(500,350) #setting the maximum size dimensions 
        #This CenterWindow method will center our app on the user's screen 
        drill50_phonebook_func.center_window(self,500,350) #accessing phonebook_func script (we have imported it above) and then centering our window and providing dimensions
        self.master.title("Student Tracking") #referencing the class and frame and creating the title for our window 
