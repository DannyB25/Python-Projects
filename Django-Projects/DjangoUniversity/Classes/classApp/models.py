...
class Meta:
    verbose_name_plural = "University Classes" #verbose name plural is what allows you to set the exact text to display in the browser/remove plural of model name
